...
const MetroSalesManagerDashboard = () => {
        ...
        lg:translate-x-0`}
            ...
            >
                ...
                <div className="pt-24 p-6">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                                <div>
                                    ...
                                    <p className="text-gray-500 mt-3 text-lg">
                                        Metro Sales Management Dashboard
                                    </p>
                                </div>
                    ...
                    {activeTab === "SiteVisitTrack" && (
                        <LeadsTab />
                    )}
                    {/* {activeTab !== "Dashboard" &&
                        activeTab !== "Attendance" && activeTab !== "LeadManagement" && (
...
export default MetroSalesManagerDashboard;