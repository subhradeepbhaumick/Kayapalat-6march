...
import PayToDealer from "./PayToDealer";
...
const OrdersTab = () => {
  ...
  const [showPayToDealerModal, setShowPayToDealerModal] = useState(false);
  ...
  const generateInvoice = (order: Order) => {
    ...
    // =====================
    const invoiceNumber = `INV-${order.o_id || new Date().getTime()}`;
  ...
  return (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  onClick={() => setShowPayToDealerModal(true)}
                >
                  Pay to Dealer
                </button>
              </div>
    ...
    `}
      ...
      {/* Pay to Dealer Modal */}
      {showPayToDealerModal && (
        <PayToDealer onClose={() => setShowPayToDealerModal(false)} />
      )}
