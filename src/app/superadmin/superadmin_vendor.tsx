...
const SuperAdmin_Vendor = () => {
    ...
    const fetchData = async () => {
        try {
            // FETCH VENDORS
            const vendorRes = await fetch("/api/superadmin/vendor");
    ...
    const fetchVendors = async () => {
        try {
            const res = await fetch("/api/superadmin/vendor");
    ...
    const handleDeleteVendor = async (user_id: string) => {
        ...
        try {
            const res = await fetch(
                `/api/superadmin/vendor?user_id=${user_id}`,
                {
                    method: "DELETE",
                }
            );
    ...
    const handleRemoveVendor = async (
        ...
        try {
            const res = await fetch(
                `/api/superadmin/project-vendor?id=${assignmentId}`,
                {
                    method: "DELETE",
                }
            );
...
export default SuperAdmin_Vendor;