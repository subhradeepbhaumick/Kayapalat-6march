              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="flex flex-col">
                  <label
                    ...
                    className="font-medium text-[#295A47] text-sm mb-2"
                  >
                    Filter by Company:
                  </label>
                  <select
                    ...
                    className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#295A47] focus:border-transparent text-sm"
                  >
