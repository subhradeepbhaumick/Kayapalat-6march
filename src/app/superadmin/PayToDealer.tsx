                ...
                <table className="w-full table-auto border-collapse border border-gray-300 text-sm">
                  <thead>
                    <tr className="bg-gradient-to-r from-[#295A47] to-[#1e3a2e] text-white shadow-lg">
                      <th className="border border-gray-300 px-4 py-3 font-semibold sticky left-0 z-10 bg-[#295A47]">
                        O_ID
                      </th>
                  ...
                  <tbody>
                    {filteredData.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          <td
                            className={`border border-gray-300 px-4 py-3 font-medium text-gray-800 sticky left-0 z-10 ${
                              index % 2 === 0 ? "bg-white" : "bg-gray-50"
                          ...
                          <td className="border border-gray-300 px-4 py-3 text-gray-700">
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <button
                                onClick={() =>
                                  setSelectedDealerId(item.dealer_id)
                                }
                                className="flex items-center px-3 py-1 bg-red-600 text-white rounded hover:bg-gray-700 transition-colors duration-200"
                              >
                          ...
                          <td className="border border-gray-300 px-4 py-3">
                            {isEditing ? (
                                  ...
                                  setEditedValues((prev) => {
                                    ...
                                    return {
                                      ...
                                      [item.o_id]: {
                                        ...
                                        company_paid: val,
                                        company_due:
                                          (current.company_total_payment || 0) -
                                          val,
                                      },
                                    };
                                  });
                              ...
                              <span className="text-green-600 font-semibold">
                                ₹{(item.company_paid || 0).toLocaleString()}
                              </span>
                            )}
                          </td>
                          <td className="border border-gray-300 px-4 py-3">
                            {isEditing ? (
                              ...
                              <span className="text-red-600 font-semibold">
                                ₹{(item.company_due || 0).toLocaleString()}
                              </span>
                            )}
                          </td>
                          <td className="border border-gray-300 px-4 py-3 text-gray-700">
                          ...
                          <td className="border border-gray-300 px-4 py-3 text-orange-600 font-semibold">
                            ₹{(item.extra_trsnsport_cost || 0).toLocaleString()}
                          </td>
                        </tr>
                      );
                    })}
