                ...
                <table className="w-full text-sm table-auto min-w-[1250px]">
                    <thead>
                        <tr className="bg-linear-to-r from-[#295A47] to-[#1f4335] text-white border-b-2 border-gray-200">
                            ...
                            <th className="md:sticky md:left-0 z-30 bg-[#295A47] px-4 py-3 text-left font-semibold whitespace-nowrap">
                                Client Name
                            </th>

                            {/* Pinned Contact Header (Offset by the estimated width of Client Name, e.g., 200px) */}
                            <th className="md:sticky md:left-[200px] z-30 bg-[#295A47] px-3 py-3 text-left font-semibold whitespace-nowrap w-32 max-w-[125px]">
                                Contact
                            </th>
                            ...
                            {activeTab === 'booking' && (
                                <>
                                    ...
                                    <th className="px-4 py-3 text-left font-semibold whitespace-nowrap">To</th>
                                    <th className="px-4 py-3 text-left font-semibold whitespace-nowrap">Status</th>
                                    <th className="px-4 py-3 text-left font-semibold whitespace-nowrap">Book in Next</th>
                        ...
                        {paginatedData.length === 0 ? (
                            ...
                            paginatedData.map((lead, index) => (
                                <tr key={lead.id} className="hover:bg-blue-50 transition-colors">
                                    ...
                                    {/* Pinned Client Name Data Cell */}
                                    <td className="md:sticky md:left-0 z-20 bg-white px-4 py-3 min-w-[200px] whitespace-nowrap">
                                    ...
                                    {/* Pinned Contact Data Cell */}
                                    <td className="md:sticky md:left-[200px] z-20 bg-white px-3 py-3 w-32 max-w-[125px] whitespace-nowrap">
