...
import { Menu, LayoutDashboard, Users, ShoppingCart, BarChart3, ClipboardList, IndianRupee, User, LogOut, Bell, TrendingUp, Package, ClipboardCheck, } from "lucide-react";
import { useSession, signOut } from "next-auth/react";
import toast from "react-hot-toast";
import LeadManagement from "./LeadManagement"; // This is correct
import EmployeeManagementPage from "./metro-employee-attendance"; // Corrected from EmployeeAttendance
import LeadsTab from "./site_visit_track";
import WorkProgress from "./work-progress";
const MetroSuperAdminDashboard = () => {
    ...
    useEffect(() => {
        // Fetch dashboard stats here later
    }, []);
    ...
    const fetchNotifications = async () => {
        try {
            const res = await fetch(
                "/api/metro/dashboard-notifications"
            );
        ...
        lg:translate-x-0`}
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-[#295A47]">
                                Metro Sales Dashboard
                            </h1>
                            <p className="text-sm text-gray-500">
                                Manage sales, bookings & revenue
                            </p>
                        </div>
                    </div>
                    {/* RIGHT */}
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                                <div>
                                    ...
                                    <p className="text-gray-500 mt-3 text-lg">
                                        Metro Management SuperAdmin Dashboard
                                    </p>
                                </div>
                                ...
                                <div className="mt-8 bg-white rounded-3xl p-8 shadow-md border">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <button
                                            ...
                                            className="bg-[#295A47] text-white px-4 py-2 rounded-xl"
                                        >
                                            See More
                                        </button>
                                    </div>
            ...
            {showNotifications && (
                <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
                    <div className="bg-white rounded-3xl w-full max-w-6xl p-6">
...
export default MetroSuperAdminDashboard;