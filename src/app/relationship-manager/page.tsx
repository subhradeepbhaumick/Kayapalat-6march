...
const relationship_managerDashboard = () => {
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Manage client relationships and sales activities
                            </p>
                        </div>
                    </div>
                    {/* RIGHT */}
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                                ...
                                <div className="bg-[#295A47]/10 px-6 py-4 rounded-2xl">
                                    ...
                                    <h2 className="text-2xl font-bold text-[#295A47]">
                                        {user?.name || "Relationship Manager"}
                                    </h2>
                                </div>
                            </div>
                        </div>
...
export default relationship_managerDashboard;